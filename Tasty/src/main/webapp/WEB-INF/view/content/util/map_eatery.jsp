...
<script type="text/javascript" src="/Tasty/script/jquery-3.2.1.min.js"></script>
<style type="text/css">
body {
	height: 700px;
	margin: 0 auto;
...
#menu_wrap {position:absolute;top:0;left:0;bottom:0;width:350px;overflow-y:auto;background:rgba(255, 255, 255, 0.7);z-index: 1;font-size:12px;}
