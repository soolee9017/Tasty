...
<body>
	...
	<h2>${requestScope.storeName}의리뷰작성페이지</h2>

	<form action="#" method="post">

		<input type="text" class="rating rating-loading" value="4"
